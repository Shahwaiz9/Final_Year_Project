        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="border border-teal-100 hover:border-teal-200 transition-colors rounded-lg p-6 bg-white shadow-sm">
              ...
              <p className="text-gray-600">
                Get personalized treatment plans and product recommendations
            ...
            <div className="border border-teal-100 hover:border-teal-200 transition-colors rounded-lg p-6 bg-white shadow-sm">
              ...
              <p className="text-gray-600">
                Quick and secure delivery of all plant care products directly to
                your doorstep.
              </p>
            </div>
            ...
            <div className="border border-teal-100 hover:border-teal-200 transition-colors rounded-lg p-6 bg-white shadow-sm">
              ...
              <p className="text-gray-600">
                Join thousands of plant enthusiasts sharing tips, experiences,
                and success stories.
              </p>
            </div>
          </div>
